import 'package:zesa_faults/screens/call_center.dart';
import 'package:flutter/material.dart';
import 'package:sizer/sizer.dart';
import 'package:page_transition/page_transition.dart';

class BottomHomeNavigation extends StatefulWidget {
  const BottomHomeNavigation({super.key});

  @override
  _BottomHomeNavigationState createState() => _BottomHomeNavigationState();
}

class _BottomHomeNavigationState extends State<BottomHomeNavigation> {
  int currentIndex = 0;
